#' performs simple preparation for email, customer name, and phone data by standardizing input data and removing common problems specific to those data types.
#' Run prior to calculating combinatorial edit distances and fuzzy matching
#' 
...
#' 
#' @examples \code{
#' email_vec <- c("Sun100@yahoo.com","RICHY5000@MSN.COM","ab?c@mac.com")
#' schr_clean_pii(email_vec, 'email')
#' (schr_clean_pii('12345678910', 'phone') == "2345678910")
#' }
